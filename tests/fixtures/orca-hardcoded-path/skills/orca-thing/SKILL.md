---
name: orca-thing
description: Use after /juel:orca-thing when a plan exists and is ready for implementation - dispatches Codex (sandboxed workspace-write) to execute the plan, honoring any commit conventions specified in the plan
metadata:
  requires:
    cli:
      - id: codex
...
**Announce at start:** "I'm using the juel:orca-thing skill to implement the plan."
...
Usage: `/juel:orca-thing` or `/juel:orca-thing ${docsRoot}/plans/2026-03-31-my-feature.md`
